...
<html lang="en">
  ...
  <body>
    ...
    <h4 class="text text-primary">Book Appointment Page</h4>
   
    <form id="booking-form" action="BookAppointmentServlet">
    ...
    <label for="username">Enter name:</label>
        ...
        <select id="doctorlist" name="doctorlist">
            ...
            <option value="Dr.sheela">Dr.sheela</option>
             <option value="Dr.sheela">Dr.John</option>
              <option value="Dr.sheela">Dr.Hari</option>
        </select>
        <br>
